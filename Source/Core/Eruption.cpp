...
void Eruption::CreateExampleScene()
{
	...
	m_AssetManager->CreateMaterial("SkullMaterial", glm::vec3(1.0f), 0.0f, 0.75f, 1.0f, m_AssetManager->GetTexture("SkullAlbedo"), m_AssetManager->GetTexture("SkullRoughness"), m_AssetManager->GetTexture("SkullNormal"));

...
en::DescriptorAllocator::DescriptorAllocator(VkDevice logicalDevice) : m_LogicalDevice(logicalDevice)
{
...
VkDescriptorSetLayout en::DescriptorAllocator::MakeLayout(const DescriptorInfo& descriptorInfo)
{
...
VkDescriptorSet en::DescriptorAllocator::MakeSet(const DescriptorInfo& descriptorInfo)
{
